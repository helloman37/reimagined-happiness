<?php
	...
	if(!empty($id_usuario)){
		...
		$result_usuario = "DELETE FROM categoria WHERE id_usuario='$id_usuario'";
		$resultado_usuario = mysqli_query($conexao, $result_usuario);

		$result_usuario = "DELETE FROM lidas WHERE id_usuario='$id_usuario'";
		$resultado_usuario = mysqli_query($conexao, $result_usuario);
		
		$result_usuario = "DELETE FROM link WHERE id_usuario='$id_usuario'";
		$resultado_usuario = mysqli_query($conexao, $result_usuario);

		$result_usuario = "DELETE FROM lista WHERE id_usuario='$id_usuario'";
		$resultado_usuario = mysqli_query($conexao, $result_usuario);
