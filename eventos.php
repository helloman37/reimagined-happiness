            ...
            <div id="conteudo-painel" class="container">
                ...
                <table class='table table-bordered table-hover table-responsive'>
                    <thead class="thead-light">
                        <tr align="center">
                            <th class='nomecol' style="width: 10%" scope="col" >ID</th>
                            <th class='nomecol' style="width: 100%" scope="col" >Evento</th>
                            <th class='nomecol' style="width: 10%" scope="col">Exc</th>
                            <th class='nomecol' style="width: 10%" scope="col">Alt</th>
                        </tr>
                    </thead>
                    <?php
                        if ($eventos){
                            ...
                            if (count($dados)) {
                                $pagination = new pagination($dados, (isset($_GET['page']) ? $_GET['page'] : 1), 2);
                                    ...
                                    echo '<tbody id="conteudo">';
                                        foreach ($dadosPages as $dadosArray) {
                                            echo '<tr class="post" align="center">';
                                                echo '<td style="text-align: center; vertical-align: middle;">'.$dadosArray['id_evento'].'</td>';
                                                echo '<td style="text-align: center; vertical-align: middle;">'.$dadosArray['nome'].'</td>';
                                                echo '<td><button class="btn btn-outline-danger" onclick="removerConfirma('."'".$dadosArray['id_evento']."'".','."'".$dadosArray['nome']."'".')"><i class="far fa-trash-alt"></i></button></td>';
                                                echo '<td><button class="btn btn-outline-secondary" onclick="editarConfirma('."'".$dadosArray['id_evento']."'".','."'".$dadosArray['nome']."'".')"><i class="fas fa-edit"></i></button></td>';
                                            echo '</tr>';
                                        }
                                    echo '</tbody>';                           
                                }else{
